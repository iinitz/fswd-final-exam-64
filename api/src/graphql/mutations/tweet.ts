...
// export const unfollow = TweetTC.mongooseResolvers.removeOne({ filter: { isRequired: true, requiredFields: ['followedId'], removeFields: ['_id', 'userId', 'createdAt', 'updatedAt'] } }).wrapResolve((next: ResolverRpCb<ITweet, IApolloContext>) => (rp: ResolverResolveParams<ITweet, IApolloContext>) => {
//   if (!rp.context.user) {
//     throw new ForbiddenError('Unauthorized')
//   }
//   const customRp: Partial<ResolverResolveParams<ITweet, IApolloContext>> = {
